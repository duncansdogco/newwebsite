      ...
      <div class="form-wrap reveal">
        ...
        <form name="enquiry" method="POST" action="/thank-you/" data-netlify="true" netlify-honeypot="bot-field">
          ...
          <div class="form-notes">
            <div class="form-note-card"><strong>Sleepovers:</strong> Spaces are limited — please enquire early, especially around holidays. Tell us your dates in the message box.</div>
