...
const servicePages = [
  ...
  },
  {
    ...
    heroData: {
      ...
      displayTitle: "Full days.<br><span>Familiar faces.</span>",
    ...
    sections: [
      ["Full days in daycare", "Every sleepover starts with a full woodland day. Same exercise, same team, same routines — so your dog arrives at bedtime genuinely tired and happy."],
      ...
      ["24-hour care", "Dogs settle into their own resting spaces when the day winds down, with the team close by through the night. The same standards, around the clock."]
    ],
    faqs: [
      ...
      ["Do dogs get a full day during a sleepover?", "Yes — every sleepover includes a full woodland daycare day. Dogs don't just arrive at bedtime; they have the same active, familiar day they always have."]
    ]
  }
];
...
const blogArticleContent = {
  ...
  "dog-boarding-vs-kennels": [
    ...
    ["Sleepovers feel familiar", ["Our sleepovers are for dogs who already know Duncan's Dog Co. They spend a full day in the woodland with the team, then settle into their own resting space when the day winds down — genuinely tired, genuinely happy."]],
...
function serviceBody(page) {
  ...
  if (page.slug === "sleepovers") {
    return `${liveIntro({ kicker: "About sleepovers", title: "Full days. Calm nights.", paragraphs: ["Dog sleepovers at Duncan's Dog Co. start with a full woodland day — the same exercise, familiar team and known routines your dog already loves. By the time evening comes, they are genuinely tired and settled. Dogs rest in their own segregated spaces, with someone on hand through the night.", "Sleepovers work best for dogs who already know us. If your dog attends daycare, an overnight stay is a natural extension of a day they already enjoy: familiar faces, familiar woodland, familiar routine.", "Whether you are travelling for work, on holiday, or just need a few nights away, we handle everything from collection to home time. Twenty-four hour care with no drop in standards. Boarding licence LN/202400651."], badge: "Licensed overnight boarding · LN/202400651", image: "https://static.wixstatic.com/media/4d2311_df80b335345d4af4ac284e695581bee2~mv2.jpg", alt: "Dog sleepover at Duncan's Dog Co." })}${authenticPhotoRibbon({ kicker: "What every sleepover includes", title: "Tired, happy dogs.", text: "A sleepover starts with a full woodland day: real exercise, familiar people, the same routines. Dogs settle into their own calm resting spaces when the day winds down, with the team close by through the night." })}<section class="section live-content"><div class="section-heading-row reveal"><div><p class="section-kicker">What to expect</p><h2>Everything included.</h2><div class="squiggle-line" aria-hidden="true"></div></div><p>Full days, calm nights and 24-hour care from a team your dog already knows.</p></div>${richFeatureGrid([["Full days in daycare", "Every sleepover starts with a full woodland day. Same exercise, same team, same routines — your dog arrives at bedtime tired and content."], ["Segregated resting spaces", "Dogs settle into their own calm spaces when the day winds down. Supervised, safe and unhurried."], ["24-hour care", "Someone is always on hand through the night. The same care standards, around the clock."], ["Same familiar team", "Dogs attending daycare already know the team before their first sleepover, making the overnight transition easy."], ["Available 365 days", "Sleepovers are available every night of the year, including Christmas, New Year and bank holidays."], ["Licensed and insured", "Boarding licence LN/202400651 is granted by Elmbridge Council. Fully insured and inspected."]])}</section>${ctaBand("Planning a trip?", "Book your dog's sleepover.", "Sleepover spaces are limited, especially over holidays. Get in touch early to check availability for your dates.")}`;
  }
