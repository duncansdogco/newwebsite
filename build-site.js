...
const assetVersion = "2026-05-22-13";
...
function clean() {
  for (const entry of fs.readdirSync(ROOT)) {
    if ([".git", ".gitignore", ".netlify", "assets", "build-site.js", "styles.css", "script.js", "netlify.toml", "gallery-contact.html", "video-contact.html", "enquiry-detect.html"].includes(entry)) continue;
